output "this_api_gateway_group_id" {
  ...
  value       = module.mobile_number_attribution.this_api_gateway_group_id
}
...
output "this_api_gateway_api_name" {
  ...
  value       = module.mobile_number_attribution.this_api_gateway_api_name
}

output "this_fc_service_id" {
  description = "The id of the fc service"
  value       = module.mobile_number_attribution.this_fc_service_id
}

output "this_fc_service_name" {
  description = "The id of the fc service"
  value       = module.mobile_number_attribution.this_fc_service_name
}

output "this_fc_function_id" {
  description = "The id of the fc function"
  value       = module.mobile_number_attribution.this_fc_function_id
}

output "this_fc_function_name" {
  description = "The id of the fc function"
  value       = module.mobile_number_attribution.this_fc_function_name
}
...
output "this_fc_service_config" {
  ...
  value       = module.mobile_number_attribution.this_fc_service_config
}
